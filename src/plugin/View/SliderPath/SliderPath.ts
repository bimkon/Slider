  ...
  mouseDown(isVertical: boolean, isRange: boolean, event: MouseEvent) {
    ...
    if (isVertical) {
      ...
      if (isRange) {
        ...
        if (this.newTop < this.midBetweenPointers) {this.dispatchThumbPosition({
  ...
  onMouseMove(isVertical:boolean, isRange:boolean, event: MouseEvent) {
    if (isVertical) {
      if (isRange) {
        ...
        const rightEdge = this.pathElement.offsetHeight - this.fromValuePointer.thumbElement.offsetHeight + this.fromValuePointer.thumbElement.offsetHeight;
      ...
      const rightEdge = this.pathElement.offsetWidth - this.fromValuePointer.thumbElement.offsetWidth + this.fromValuePointer.thumbElement.offsetWidth;
