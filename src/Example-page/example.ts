...
//         // let rightRange = getCoords(thumbMax).right - getCoords(thumbMin).left;
...
//         // range.style.width = rightRange + 'px';
//       }
...
//       function onMouseMove(event) {
//         let newLeft = event.clientX - shiftX - sliderCoords.left;
//         // let leftRange = getCoords(thumbMax).right - getCoords(thumbMin).left;
//         let rightRange = sliderCoords.right - getCoords(thumbMax).right;
//         // курсор вышел из слайдера => оставить бегунок в его границах.
//         if (newLeft < 0) {
//           newLeft = 0;
...
//         // range.style.width = leftRange + 'px';
//         range.style.right = rightRange + 'px';
